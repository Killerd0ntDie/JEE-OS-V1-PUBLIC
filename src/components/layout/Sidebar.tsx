...
export function Sidebar({
  ...
  const renderSidebarContent = (collapsed: boolean) => (
    <div
      className={`h-full bg-black/60 backdrop-blur-xl shadow-2xl border-r border-zinc-800/80 flex flex-col justify-between select-none transition-[width] duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] transform-gpu will-change-[width] ${
