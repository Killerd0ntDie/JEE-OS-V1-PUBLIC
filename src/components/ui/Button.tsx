...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className = '', variant = 'default', size = 'md', children, ...props }, ref) => {
    ...
    const baseStyle =
      'inline-flex items-center justify-center font-medium rounded-lg transition-all duration-200 ease-[cubic-bezier(0.16,1,0.3,1)] focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500/50 focus-visible:ring-offset-2 focus-visible:ring-offset-zinc-950 disabled:opacity-50 disabled:pointer-events-none cursor-pointer active:scale-[0.98] select-none';

    // Variant Styles
    const variants = {
      default:
        'bg-white text-zinc-950 hover:bg-zinc-200 shadow-[0_1px_2px_rgba(255,255,255,0.08)] hover:shadow-md',
      secondary:
        'bg-zinc-900 text-zinc-100 border border-zinc-800 hover:bg-zinc-850 hover:text-white hover:border-zinc-700 hover:shadow-lg hover:shadow-zinc-900/50',
      ghost:
        'text-zinc-400 hover:bg-zinc-900 hover:text-zinc-100 active:bg-zinc-850',
      accent:
        'bg-indigo-600 hover:bg-indigo-500 text-white shadow-[0_1px_2px_rgba(99,102,241,0.3)] hover:shadow-[0_0_16px_rgba(99,102,241,0.4)]',
      outline:
