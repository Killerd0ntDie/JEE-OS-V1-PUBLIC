...
export const HoldNotificationModal: React.FC<HoldNotificationModalProps> = ({
  ...
  return (
      ...
      <Modal isOpen={isOpen} onClose={onClose} zIndex={50} backdropClassName="p-4 bg-black/35 backdrop-blur-sm animate-in fade-in duration-200" className="relative bg-[#09090b] border border-amber-500/40 rounded-3xl max-w-md w-full p-6 shadow-2xl z-50 text-left space-y-5">
          {/* Header */}
