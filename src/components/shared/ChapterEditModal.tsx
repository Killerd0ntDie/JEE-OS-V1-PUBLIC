  ...
  return (
    <>
      <Modal 
        ...
        className="w-full max-w-2xl h-[670px] max-h-[92vh] flex flex-col bg-[#090a0f] border border-zinc-800/90 rounded-3xl shadow-2xl overflow-hidden focus:outline-none text-left"
      >
        {/* Toast */}
        {showSuccessToast && (
