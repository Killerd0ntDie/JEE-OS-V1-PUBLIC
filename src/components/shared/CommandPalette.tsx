  ...
  return createPortal(
    <div
      className={`fixed inset-0 z-[999] flex items-start justify-center p-4 pt-[12vh] transition-all duration-200 ${
        isOpen ? 'bg-black/60 backdrop-blur-sm visible pointer-events-auto' : 'bg-transparent backdrop-blur-none invisible pointer-events-none'
      }`}
      onClick={onClose}
    ...
    >
      ...
      <div
        ...
        className={`w-full max-w-xl glass-panel rounded-2xl shadow-2xl overflow-hidden flex flex-col relative transition-all duration-200 ease-out border border-zinc-800/80 bg-zinc-950/90 backdrop-blur-2xl ${
