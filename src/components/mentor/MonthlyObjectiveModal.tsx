...
export const MonthlyObjectiveModal: React.FC<Props> = ({ isOpen, onClose }) => {
  ...
  return (
    ...
    <Modal isOpen={isOpen} onClose={onClose} zIndex={50} backdropClassName="p-4 bg-black/10 backdrop-blur-md animate-fade-in overflow-y-auto text-left" className="relative w-full max-w-xl border border-indigo-900/50 rounded-2xl shadow-2xl overflow-hidden my-6 glass-panel">
