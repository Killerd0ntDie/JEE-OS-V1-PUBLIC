    ...
    >
      ...
      <AnimatePresence>
        {recalledToast && (
          <motion.div
            ...
            className="absolute top-4 left-1/2 -translate-x-1/2 z-50 glass-panel bg-emerald-950/90 border border-emerald-500/50 text-emerald-200 text-xs px-4 py-2 rounded-2xl shadow-xl flex items-center gap-2 font-mono"
          >
      ...
      <div className="p-5 md:p-6 border-b border-white/10 flex items-start justify-between relative z-10 shrink-0">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.92 }}
          onClick={onClose}
          className="p-2 rounded-2xl glass-panel bg-zinc-950/60 hover:bg-zinc-800 border border-white/10 text-zinc-400 hover:text-white transition-colors cursor-pointer shrink-0 shadow-sm"
        >
          <X className="w-4 h-4" />
        </motion.button>
      </div>
      ...
      <div className="p-5 md:p-6 overflow-y-auto scrollbar space-y-4 flex-1 h-[420px]">
        ...
        {activeTab === 'overview' && (
          <div className="space-y-4 flex flex-col justify-between h-full">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-2xl glass-panel bg-zinc-950/60 border border-white/10 space-y-3 shadow-inner">
              ...
              <div className="grid grid-cols-3 gap-3 font-mono text-xs">
                <div className="p-3 rounded-2xl glass-panel bg-zinc-950/60 border border-white/10 text-center space-y-1 shadow-sm">
            ...
            <div className="flex flex-col sm:flex-row gap-2.5 pt-2 mt-auto">
              <motion.button
                ...
                className="flex-1 h-11 px-4 rounded-xl glass-panel bg-zinc-900/60 hover:bg-zinc-800/80 border border-white/15 text-zinc-200 hover:text-white text-xs font-mono font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm"
              >
              ...
              {onPracticeWithAI && (
                <motion.button
                  ...
                  className="flex-1 h-11 px-4 rounded-xl glass-panel bg-indigo-950/60 hover:bg-indigo-900/70 border border-indigo-500/40 text-indigo-200 hover:text-white text-xs font-mono font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2 shadow-sm"
                >
              ...
              <motion.button
                ...
                className="h-11 px-4 rounded-xl glass-panel bg-zinc-900/60 hover:bg-zinc-800/80 border border-white/15 text-zinc-300 hover:text-white text-xs font-mono font-bold uppercase tracking-wider transition-all cursor-pointer flex items-center justify-center gap-2 shrink-0 shadow-sm"
        ...
        {activeTab === 'formulas' && (
          <div className="space-y-3">
            {formulas.length === 0 ? (
              <div className="p-12 text-center text-zinc-400 font-mono text-xs glass-panel bg-zinc-950/60 border border-white/10 rounded-2xl flex flex-col items-center justify-center gap-2">
              ...
              formulas.map((f, idx) => {
                ...
                return (
                  <div 
                    key={idx}
                    className={`p-4 rounded-2xl border transition-all text-left space-y-3 glass-panel backdrop-blur-xl shadow-md ${
                      isFlipped 
          ...
          <div className="space-y-3">
            ...
            {chapSessions.length === 0 ? (
              ...
              chapSessions.map((sess, idx) => (
                <div key={idx} className="p-3.5 rounded-2xl glass-panel bg-zinc-950/60 border border-white/10 flex items-center justify-between text-xs font-mono shadow-sm">
