    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6 text-left font-sans select-none pb-16">
        ...
        <div className="glass-panel bg-zinc-900/70 backdrop-blur-2xl border border-white/15 p-12 rounded-3xl text-center space-y-6 shadow-2xl">
          <div className="w-16 h-16 mx-auto glass-panel bg-amber-950/60 rounded-full flex items-center justify-center border border-amber-500/40 text-amber-400 shadow-lg">
    ...
    return (
      <div className="max-w-4xl mx-auto space-y-6 text-left font-sans select-none pb-16">
        ...
        >
          ...
          <div className="w-20 h-20 mx-auto glass-panel bg-amber-950/60 rounded-full flex items-center justify-center border border-amber-500/40 shadow-xl shadow-amber-600/30">
          ...
          <div className="grid grid-cols-3 gap-4 max-w-xl mx-auto font-mono text-xs">
            ...
            <div className="glass-panel bg-zinc-950/60 border border-amber-500/30 p-4 rounded-2xl text-center shadow-md">
    ...
    <div className="max-w-4xl mx-auto space-y-6 text-left font-sans select-none pb-16">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
        ...
        <div className="flex items-center gap-2.5 font-mono text-xs">
          {streak > 0 && (
            <div className="p-2 px-3 rounded-2xl glass-panel bg-amber-950/60 border border-amber-500/40 text-amber-300 flex items-center gap-1.5 shadow-sm animate-pulse">
              <Flame className="w-3.5 h-3.5 text-amber-400" />
              <span>{streak}x Streak</span>
            </div>
          )}

          <div className={`p-2 px-4 rounded-2xl glass-panel border flex items-center gap-2 shadow-md ${
      ...
      {currentCard && (
        <motion.div
          ...
          className={`p-6 md:p-10 rounded-3xl glass-panel border text-left flex flex-col justify-between space-y-6 shadow-2xl relative transition-all min-h-[380px] ${
            isFlipped 
        ...
        >
          ...
          >
            ...
            {isFlipped ? (
              ...
              >
                ...
                <div className="p-4 rounded-2xl glass-panel bg-zinc-950/95 border border-emerald-500/40 text-emerald-200 font-mono text-sm leading-relaxed overflow-x-auto shadow-inner">
          ...
          <div className="grid grid-cols-2 gap-3 pt-4 border-t border-white/10 font-mono text-xs">
            <button
              ...
              className="p-4 rounded-2xl glass-panel bg-red-950/40 hover:bg-red-900/60 text-red-300 border border-red-500/40 flex items-center justify-center gap-2 cursor-pointer font-bold transition-all active:scale-95 shadow-sm"
            >
              <X className="w-4 h-4" />
            ...
            <button
              ...
              className="p-4 rounded-2xl glass-panel bg-emerald-950/40 hover:bg-emerald-900/60 text-emerald-300 border border-emerald-500/40 flex items-center justify-center gap-2 cursor-pointer font-bold transition-all active:scale-95 shadow-sm"
            >
