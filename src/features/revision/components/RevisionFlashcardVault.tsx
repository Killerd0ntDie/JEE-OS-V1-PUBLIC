  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto text-left relative font-sans select-none pb-16">
      ...
      <AnimatePresence>
        {recalledToast && (
          <motion.div
            ...
            className="fixed top-6 right-6 z-50 bg-emerald-950/90 border border-emerald-500/50 text-emerald-200 text-xs px-4 py-2.5 rounded-2xl shadow-2xl flex items-center gap-2 font-mono"
          >
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-white/10 pb-4">
        ...
        <div className="flex items-center gap-1 bg-zinc-950/95 p-1 rounded-2xl font-mono text-xs relative shrink-0">
          <button
            onClick={() => {
              setVaultView('cards');
      ...
      <div className="bg-zinc-900/90 border border-white/10 rounded-3xl p-4 md:p-5 space-y-3.5 shadow-xl">
        ...
        <div className="flex flex-col sm:flex-row gap-3">
          ...
          <div className="flex gap-1 bg-zinc-950/95 p-1 rounded-2xl font-mono text-xs shrink-0">
              ...
              {matrixChaptersToDisplay.map((chap) => {
                ...
                return (
                  <div
                    ...
                    className={`p-4 rounded-3xl border  transition-all cursor-pointer flex flex-col justify-between space-y-3 group shadow-md ${
                      isOverdue
