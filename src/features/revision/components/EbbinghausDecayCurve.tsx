...
export function EbbinghausDecayCurve({
  ...
  return (
    <div className="bg-zinc-900/90 border border-white/15 rounded-3xl p-5 md:p-6 space-y-5 text-left select-none shadow-2xl relative overflow-hidden">
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-white/10 pb-4 relative z-10">
        ...
        <div className="flex items-center gap-2.5 shrink-0 font-mono text-xs">
          <div className="bg-zinc-950/70 border border-white/10 p-2.5 px-3.5 rounded-2xl space-y-0.5 text-center shadow-md">
          ...
          <div className="bg-emerald-950/60 border border-emerald-500/40 p-2.5 px-3.5 rounded-2xl space-y-0.5 text-center shadow-md">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 font-mono text-xs">
        <div className="flex gap-1 bg-zinc-950/95 p-1 rounded-2xl">
          <button
      ...
      {activeTab === 'curve' && (
        <div className="space-y-4">
          <div className="relative bg-zinc-950/80 border border-white/10 rounded-2xl p-4 md:p-5 shadow-inner">
      ...
      {activeTab === 'chapters' && (
        <div className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bg-zinc-950/60 border border-red-500/30 rounded-2xl p-4 space-y-3 shadow-md">
            ...
            <div className="bg-zinc-950/60 border border-amber-500/30 rounded-2xl p-4 space-y-3 shadow-md">
            ...
            <div className="bg-zinc-950/60 border border-emerald-500/30 rounded-2xl p-4 space-y-3 shadow-md">
      ...
      {activeTab === 'math' && (
        <div className="bg-zinc-950/70 border border-white/10 rounded-2xl p-5 space-y-4 font-sans text-xs leading-relaxed text-zinc-300 shadow-inner">
