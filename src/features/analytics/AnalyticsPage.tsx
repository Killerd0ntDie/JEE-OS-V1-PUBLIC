...
export function AnalyticsPage() {
  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto text-left relative pb-12 font-sans select-none">
      ...
      <div className="glass-panel bg-zinc-900/70 backdrop-blur-2xl border border-white/15 p-5 md:p-6 rounded-3xl shadow-2xl flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        {/* Level Badge Card */}
        <div className="glass-panel bg-indigo-950/60 border border-indigo-500/40 p-3.5 rounded-2xl shrink-0 font-mono text-left space-y-1.5 shadow-lg shadow-indigo-600/10">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3.5 font-mono">
        <div className="glass-panel bg-zinc-900/70 border border-emerald-500/30 backdrop-blur-xl p-4 rounded-2xl space-y-1 shadow-xl">
        ...
        <div className="glass-panel bg-zinc-900/70 border border-indigo-500/30 backdrop-blur-xl p-4 rounded-2xl space-y-1 shadow-xl">
        ...
        <div className="glass-panel bg-zinc-900/70 border border-amber-500/30 backdrop-blur-xl p-4 rounded-2xl space-y-1 shadow-xl">
        ...
        <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-xl p-4 rounded-2xl space-y-1 shadow-xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-3.5 font-mono">
        <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-xl p-4 rounded-2xl space-y-2 shadow-xl">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-2xl rounded-3xl p-5 space-y-3.5 text-left flex flex-col shadow-2xl">
        ...
        <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-2xl rounded-3xl p-5 space-y-3.5 text-left flex flex-col shadow-2xl">
          ...
          <div className="flex-1 flex flex-col justify-center items-center gap-5">
            ...
            >
              ...
              <div className="w-24 h-24 glass-panel bg-zinc-950/90 backdrop-blur-md rounded-full flex items-center justify-center flex-col shadow-inner border border-white/15">
          ...
          <div className="flex items-end justify-between gap-2 h-36 pt-4 flex-1">
            {sevenDayVelocity.map((day, idx) => {
              ...
              return (
                ...
                >
                  <div className={`absolute -top-7 glass-panel bg-zinc-900 border border-white/20 text-white text-[10px] font-mono px-2 py-0.5 rounded-md pointer-events-none transition-opacity z-10 whitespace-nowrap shadow-lg ${
      ...
      <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-2xl rounded-3xl p-5 md:p-6 space-y-4 text-left shadow-2xl">
      ...
      <div className="glass-panel bg-zinc-900/70 border border-white/15 backdrop-blur-2xl rounded-3xl p-5 md:p-6 space-y-4 text-left shadow-2xl relative overflow-hidden">
            ...
            <AnimatePresence>
              {hoveredDecayChapter && (
                <motion.div
                  ...
                  className="absolute top-2 left-1/2 -translate-x-1/2 glass-panel bg-zinc-900/95 backdrop-blur-2xl border border-white/20 p-3 rounded-2xl shadow-2xl font-mono text-xs pointer-events-none z-30 space-y-1 min-w-[240px]"
                >
