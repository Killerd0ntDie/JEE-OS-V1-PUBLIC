    ...
    <div className="bg-red-950/20 border border-red-900/40 rounded-2xl p-6 backdrop-blur-xl shadow-xl space-y-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 pt-2">
        ...
        >
          ...
          <p className="text-[10px] text-zinc-400 leading-relaxed">Clear all custom missions and unhide previously dismissed tasks.</p>
        </button>
        ...
        >
          <div className="flex items-center justify-between mb-2">
            <span className="text-xs font-mono font-bold text-red-300">Purge Entire Workspace</span>
            <Trash2 className="w-4 h-4 text-red-400" />
          </div>
          <p className="text-[10px] text-red-300/70 leading-relaxed">Nuclear option: Wipe all local cache, telemetry, and reset to initial state.</p>
        </button>
      </div>
    </div>
  );
