  ...
  return (
    <div className="relative inline-block text-left">
      <button
        ...
        className="px-2.5 py-1 rounded-lg bg-amber-950/40 hover:bg-amber-900/60 border border-amber-500/40 text-amber-300 font-mono text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer shadow-sm"
      ...
      {isExpanded && (
        <div className="absolute left-0 top-8 z-50 w-72 p-3 rounded-xl bg-[#090a0f] border border-amber-500/40 shadow-2xl space-y-2 text-xs font-mono">
          <div className="text-[10px] font-bold text-amber-400 uppercase tracking-wider flex items-center justify-between border-b border-zinc-800 pb-1.5">
            ...
            <span className="text-zinc-500 text-[9px]">Click to inspect</span>
          </div>
          <div className="max-h-48 overflow-y-auto space-y-1.5 custom-scrollbar pr-1">
            {onHoldChapters.map(c => (
              ...
              >
                ...
                <span className="text-[9px] opacity-75 shrink-0 ml-2">
