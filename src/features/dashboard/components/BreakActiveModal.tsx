...
export function BreakActiveModal({ isOpen, onClose, breakMission }: BreakActiveModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} zIndex={120} className="max-w-lg w-full p-8 rounded-3xl border border-amber-500/30 text-white shadow-[0_0_50px_rgba(245,158,11,0.15)] text-center relative overflow-hidden bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10">
