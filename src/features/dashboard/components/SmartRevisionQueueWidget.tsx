    ...
    <Card className="p-5 border-zinc-800/80 bg-zinc-950/40 space-y-4 flex-1 flex flex-col justify-between">
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <span className="text-[11px] font-mono tracking-wider text-indigo-400 font-bold uppercase block">
              ...
              >
                <div className="space-y-1 min-w-0 flex-1">
                  <div className="flex items-center gap-1.5 flex-wrap">
                    ...
                    {rev.isCritical && (
                      <span className="text-[11px] font-mono text-red-400 font-bold bg-red-950/30 border border-red-900 px-1 py-0.2 rounded">
                        OVERDUE
                      </span>
                    )}
                  </div>
                ...
                <Button
                  ...
                  className="px-3 py-1 text-[11px] font-mono font-bold border border-indigo-900/60 bg-indigo-950/50 text-indigo-300 hover:bg-indigo-600 hover:text-white transition-all shrink-0 uppercase tracking-wider"
                >
                  REV
                </Button>
              </div>
