...
export function RoutineBreakModal({ isOpen, onClose }: RoutineBreakModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} zIndex={100} className="max-w-md w-full p-6 rounded-2xl border border-zinc-800 text-white shadow-2xl bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10">
