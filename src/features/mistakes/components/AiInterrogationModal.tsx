...
export const AiInterrogationModal: React.FC<AiInterrogationModalProps> = ({
  ...
  return (
    <Modal isOpen={isOpen && !!mistake} onClose={handleClose} className="w-full h-[90vh] max-w-5xl rounded-3xl overflow-hidden shadow-[0_0_80px_rgba(220,38,38,0.15)] flex flex-col border border-red-900/50 glass-panel">
          {/* Header */}
