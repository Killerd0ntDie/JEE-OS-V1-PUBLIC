  ...
  return (
    <div className="flex flex-wrap items-center justify-center gap-2 sm:gap-2.5 pt-1">
      ...
      <button 
        ...
        className="flex items-center gap-1.5 px-3 sm:px-3.5 py-2 rounded-lg border border-zinc-800 hover:border-zinc-700 bg-[#0c0c0e]/40 text-[10px] sm:text-xs font-mono text-zinc-400 transition-colors"
      >
        <RotateCcw className="w-3.5 h-3.5" />
        <span>{lectureSpeed}x</span>
      </button>
      ...
      {!isCoachVisible && (
        <button 
          ...
          className="flex items-center gap-1.5 px-2 sm:px-3 py-2 rounded-lg border border-indigo-900/40 bg-indigo-950/20 hover:bg-indigo-950/40 text-[10px] sm:text-xs font-mono text-indigo-400 transition-all"
