...
export function CasinoSetupOverlay({
  ...
  return (
    <Modal
      ...
      className="w-full max-w-md border border-red-900/50 rounded-3xl p-8 shadow-[0_0_80px_rgba(220,38,38,0.15)] flex flex-col items-center text-center space-y-6 bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10"
    >
...
export function CasinoFailureOverlay({
  ...
  return (
    <Modal
      ...
      className="w-full max-w-md border border-red-500 rounded-3xl p-8 shadow-[0_0_100px_rgba(220,38,38,0.4)] flex flex-col items-center text-center space-y-6 bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10"
    >
