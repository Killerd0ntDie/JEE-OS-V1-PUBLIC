...
export function MissionTimeUpModal({
  ...
  return (
    <Modal isOpen={isOpen} onClose={onComplete} zIndex={10000} className="max-w-md w-full border border-zinc-800 rounded-3xl p-8 shadow-2xl relative z-10 space-y-6 text-left bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10">
