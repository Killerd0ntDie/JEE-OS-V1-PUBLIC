...
export const SwapSubjectModal: React.FC<SwapSubjectModalProps> = ({
  ...
  return (
    <>
    <Modal isOpen={isOpen} onClose={onClose} zIndex={10000} className="relative border border-zinc-800 rounded-3xl max-w-lg w-full p-6 shadow-2xl z-50 text-left space-y-5">
          {/* Header */}
