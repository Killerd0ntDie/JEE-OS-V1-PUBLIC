...
export function MissionMode({ 
  ...
  // Casino Penalty: If wager > 0 and user leaves tab, mission fails immediately!
  useEffect(() => {
  ...
  return (
    <ModalPortal>
      <div className="fixed inset-0 z-[9999] bg-[#070708] text-zinc-100 flex flex-col font-sans overflow-hidden select-none">
        ...
        {/* Casino Setup Overlay */}
        {isSettingUp && (
        <div className="absolute inset-0 z-[100] bg-zinc-950/90 backdrop-blur-md flex items-center justify-center p-6 animate-in fade-in zoom-in-95 duration-500">
          <div className="w-full max-w-md bg-[#09090b] border border-red-900/50 rounded-3xl p-8 shadow-[0_0_80px_rgba(220,38,38,0.15)] flex flex-col items-center text-center space-y-6">
            ...
            <div className="w-full space-y-4 bg-zinc-900/50 p-5 rounded-2xl border border-zinc-800">
              <div className="flex items-center justify-between">
                <span className="text-xs font-mono font-bold text-zinc-500 uppercase">Wager Amount</span>
      ...
      {/* Casino Failure Overlay */}
      {missionFailed && (
        <div className="absolute inset-0 z-[100] bg-red-950/90 backdrop-blur-md flex items-center justify-center p-6 animate-in fade-in zoom-in-95 duration-500">
          <div className="w-full max-w-md bg-[#09090b] border border-red-500 rounded-3xl p-8 shadow-[0_0_100px_rgba(220,38,38,0.4)] flex flex-col items-center text-center space-y-6">
