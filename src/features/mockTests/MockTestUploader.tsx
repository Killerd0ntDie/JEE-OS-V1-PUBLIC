...
export function MockTestUploader({ isOpen, onUpload, onCancel }: MockTestUploaderProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} zIndex={50} backdropClassName="bg-black/40 backdrop-blur-md p-4" className="bg-zinc-950/98 border border-zinc-800 rounded-3xl p-6 w-full max-w-md shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] relative text-left">
