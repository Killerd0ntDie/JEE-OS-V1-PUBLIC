...
export function UploadPDFModal({ isOpen, onSuccess, onCancel }: UploadPDFModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onCancel} zIndex={200} backdropClassName="bg-black/40 backdrop-blur-md p-4" className="bg-black/45 backdrop-blur-2xl shadow-[0_8px_32px_rgba(0,0,0,0.4)] border border-white/10 backdrop-blur-2xl border border-white/10 rounded-3xl p-6 w-full max-w-md shadow-[0_25px_60px_-15px_rgba(0,0,0,0.8)] relative text-left">
